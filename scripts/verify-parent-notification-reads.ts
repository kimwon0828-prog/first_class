...
assert(home.includes('hasHomeUnreadNotifications(notificationResult)') && !home.includes('hasPendingReports'))
...
assert(read('src/features/notifications/queries/get-home-notifications.ts').includes('result?.readStateStatus === "available"'))
